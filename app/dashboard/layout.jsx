    ...
    return (
        ...
        <div>
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-[220px,1fr] ">
                ...
                <div className={`absolute z-10 duration-500 block sm:hidden ${toggle ? 'left-0' : '-left-56'}`}>

                    <ul className="w-[220px] min-h-screen p-2 bg-slate-200 ">
                        <Link
                            onClick={(() => setToggle(false))}
                            href='/dashboard/addProduct'> <li className="hover:bg-gray-900 hover:text-white duration-300 rounded-md px-4  py-2 cursor-pointer text-gray-700">Add Product</li></Link>
                        <Link
                            onClick={(() => setToggle(false))}
                            href='/dashboard/myProduct'><li className="hover:bg-gray-900 hover:text-white duration-300 rounded-md px-4  py-2  cursor-pointer text-gray-700">My Product</li></Link>
                        <Link
                            onClick={(() => setToggle(false))}
                            href='/dashboard/progress'><li className="hover:bg-gray-900 hover:text-white duration-300 rounded-md px-4  py-2  cursor-pointer text-gray-700">Progress</li></Link>
                    </ul>
                </div>
